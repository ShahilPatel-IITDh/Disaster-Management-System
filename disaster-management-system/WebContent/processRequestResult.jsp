...
<main class="flex-shrink-0">
  ...
  if(result.equals("Fail")) {%>
    	<center><h3 class="mt-5">Error!</h3></center>
    	<p class="lead">Please check if proper Blood Stock ID, Recipient ID are entered. Check Blood Compatibility Chart.</p>
  <% } else{ %>
  	<center><h3 class="mt-5">Success!</h3></center>
  <% } %>
  	  <div class="wrapper">
    </div>
  </div>
