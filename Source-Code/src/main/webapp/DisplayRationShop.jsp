...
<main class="flex-shrink-0">
  <div style="width: 60%;" class="container">
    <h1 class="mt-5" style="color:#2f4858; text-align:center; font-size:50px">Ration Shop</h1>
    <div class="bd-example">
        <table class="table table-striped">
          ...
          <% 
		     ...
		     if (request.getAttribute("RationList") != null) {
		         rows = (ArrayList ) request.getAttribute("RationList");
